...
1. Clone our copy of the ruby-nessus gem and install it
  git clone git://github.com/AsteriskLabs/ruby-nessus.git
  cd ruby-nessus
  rake install
2. Install the Prenus gem
  gem install prenus

== Usage

1. Download the .nessus files from Nessus you want to Prettify (make sure they're version 2 files, not version 1)
2. Cd into the folder where the files are
3. Run Prenus
