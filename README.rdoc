...
If you want to add some optional branding to top of the index.html file (when using HTML output type). Create a file with some HTML content, and then point this option to the file. Voila. BRAAANDING
